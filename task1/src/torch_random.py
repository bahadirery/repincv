...
def manual_seed(seed) -> torch._C.Generator:
    ...
    ''' By using this function call, we can set the seed for CUDA as well. But we do not want to do that.'''
    #import torch.cuda
#
...
#
    ...
    ''' We want to set the seed for CPU only. So we use the following function call.'''
